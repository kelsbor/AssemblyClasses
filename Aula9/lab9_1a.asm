...
MAIN PROC
          ...
          lea  BX, VETOR    ; aponta para o primeiro endereço do VETOR
          mov  AH, 02       ; função para printar caracter
    
    VOLTA:
          mov  DL, [BX]     ; move para dl, o conteudo do primeiro endereço do VETOR
          inc  BX           ; incrementa bx para apontar o próximo endereço.
